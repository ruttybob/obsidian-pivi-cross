...
/** Workspace location used when opening the Yapi chat view. */
...
export function getHiddenSlashCommands(
  settings: Pick<YapiSettings, "hiddenSlashCommands">,
): string[] {
...
/**
 * Application settings stored in .yapi/settings.json.
 *
