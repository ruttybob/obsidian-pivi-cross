...
/** Mask-based Yapi p icon (matches ribbon `yapi-p` orientation). */
export interface ChatYapiBrandIconSvg {
  kind: 'yapi-brand';
  viewBox: string;
}

/** SVG icon descriptor for chat toolbar and model selectors. */
export type ChatIconSvg = ChatPathIconSvg | ChatCompositeIconSvg | ChatYapiBrandIconSvg;
