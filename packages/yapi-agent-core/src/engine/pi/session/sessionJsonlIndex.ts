...
function scanJsonlLines(
  ...
  while (lineStart < content.length) {
    ...
    const hasLegacyExternalContext = (
      parsed.customType === YAPI_UI_CONTEXT
      && Object.hasOwn(data ?? {}, 'externalContextPaths')
    ) || (
      parsed.customType === YAPI_MESSAGE_UI
    ...
    lines.push({
      ...
      ...(message?.role === 'user'
        ...
        : {}),
      ...(parsed.customType === YAPI_MESSAGE_UI && typeof data?.displayContent === 'string'
