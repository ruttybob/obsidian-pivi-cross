...
export const COMPACTION_SYSTEM_PROMPT = `You are currently performing context compaction for Yapi before the next chat turn continues.
...
export function buildCheckpoint(
  ...
  const checkpoint = parseYapiCompactionDetails({
    yapiCheckpoint: {
