...
export interface SystemPromptBuildOptions {
  appendices?: string[];
  /** ISO date string injected into the prompt (Yapi runtime). */
...
You are **Yapi**, an expert AI assistant specialized in Obsidian vault management, knowledge organization, and code analysis. You operate directly inside the user's Obsidian vault.
