...
export const YAPI_SESSION_META = 'yapi/session-meta';
export const YAPI_UI_CONTEXT = 'yapi/ui-context';
export const YAPI_MESSAGE_UI = 'yapi/message-ui';

export interface YapiSessionMetaData {
  title: string;
...
export interface YapiUiContextData {
  currentNote?: string;
...
export interface YapiMessageUiData {
