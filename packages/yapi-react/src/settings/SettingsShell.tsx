...
export function SettingsShell({ initialTab = 'general', children }: SettingsShellProps) {
  ...
  return (
    <div className="yapi-settings">
      <div className="yapi-settings-tabs" role="tablist" aria-label={t('settings.tabs.ariaLabel')}>
        {TABS.map((tab, index) => {
          ...
          return (
            <button
              ...
              type="button"
              className={`yapi-settings-tab${selected ? ' yapi-settings-tab--active' : ''}`}
              role="tab"
      ...
      <div
        id={panelId}
        className="yapi-settings-content"
        role="tabpanel"
