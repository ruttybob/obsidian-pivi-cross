import type { WebProviderId, WebSearchToolsSettings } from '@yapi/yapi-agent-core/foundation/settings';
  ...
  return (
    <>
      <SettingsPageDescription>
        <p className="yapi-setting-description">{t('settings.webSearch.intro')}</p>
      </SettingsPageDescription>
      <div className="yapi-providers-list" ref={reorder.listRef}>
      ...
      <div className="yapi-web-fallback-note">
        <p>{t('settings.webSearch.fixedFallbacks')}</p>
      </div>
      <div className="yapi-visually-hidden" aria-live="polite">{reorder.announcement}</div>
    </>
  );
}
