...
const THINKING_ITEM_KEY = 'yapi:streaming-thinking';
const HISTORY_BOUNDARY_ITEM_KEY = 'yapi:older-history-boundary';
...
export function MessageList({
  ...
  useLayoutEffect(() => {
    ...
    recorder.onVirtualRows(
      root.querySelectorAll('.yapi-message-virtual-row').length,
  ...
  if (count === 0) {
    return (
      <DisclosureAnchorProvider beginDisclosureResize={beginDisclosureResize}>
        <div className="yapi-message-list" ref={listRef} />
  ...
  return (
    <DisclosureAnchorProvider beginDisclosureResize={beginDisclosureResize}>
      <div
        className="yapi-message-list yapi-message-list-virtual"
        ref={listRef}
      ...
      >
        ...
        return (
          <div
            className="yapi-message-virtual-row"
