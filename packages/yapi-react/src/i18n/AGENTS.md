...
Run `npm run test -- tests/yapi-react/i18n.test.tsx`, `npm run check:i18n-dead-keys`, `npm run typecheck`, and `npm run lint` after catalog or translator changes. Placeholder parity should be covered alongside key-tree parity.
