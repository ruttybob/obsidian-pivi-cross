...
export function ComposerChrome({
  ...
  return (
    <div className="yapi-input-toolbar">
      ...
      <ModeSelector
        ...
        value={composer.mode}
      />
      <div className="yapi-input-action-group">
        <UsageMeter usage={snapshot.usage} />
        <div className="yapi-send-button-wrap">
          <button
            ...
            className={`yapi-send-button yapi-send-${snapshot.isStreaming ? 'streaming' : composer.canSend ? 'ready' : 'disabled'}`}
