...
import { ChatTabsStore, type ChatTabActions } from '@yapi/yapi-react/store';
...
describe('React surface mounts', () => {
  it('gives the imperative chat adapter one isolated container and disposes once', async () => {
    ...
    const reactContainer = hostContainer.querySelector('[data-yapi-react-surface="chat"]');
  ...
  it('mounts settings with the supplied owner realm', async () => {
    ...
    expect(hostContainer.querySelector('[data-yapi-react-surface="settings"]')).not.toBeNull();
