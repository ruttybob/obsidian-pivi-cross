...
import type { ChatTurnMetadata, PreparedChatTurn } from '@yapi/yapi-agent-core/runtime/types';
...
describe('AgentCoreRuntime multi-client hosts', () => {
  it('runs obsidian-vault and cli-project hosts through the same core runtime without core changes', async () => {
    ...
    expect(cliSessions.createPaths).toEqual(['file:///Users/dev/yapi-cli']);
    ...
    const cliTools = await cliRuntime.listToolSpecs({ cwd: '/Users/dev/yapi-cli' });
