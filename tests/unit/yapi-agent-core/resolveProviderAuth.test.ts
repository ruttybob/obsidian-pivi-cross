import { resolveProviderAuth } from '@yapi/yapi-agent-core/auth/resolveProviderAuth';
import type { ModelAuthHost, ProviderAuthModel } from '@yapi/yapi-agent-core/ports';
